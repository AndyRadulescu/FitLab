      ...
      <div className="max-w-3xl mx-auto px-6 py-12 lg:py-20">
        ...
        <main className="space-y-12 leading-relaxed">
          <section>
            ...
            <p>
              To provide a personalized fitness tracking experience, we collect
              the following:
            </p>
            <ul className="list-disc ml-6 mt-4 space-y-3 marker:text-primary">
              <li>
                <strong className="text-white">Account Data:</strong> Email
                address and name provided during sign-up via Firebase
                Authentication.
              </li>
              <li>
                <strong className="text-white">Progress Photos:</strong> Photos
                you upload to track your physical transformation.
              </li>
              <li>
              ...
              <li>
                ...
                analytics regarding how you interact with the app.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Your privacy is our priority. Photos uploaded to Amazonia - FitLab
              are stored securely and used{' '}
              <span className="italic text-white underline decoration-primary underline-offset-4">
                strictly
              </span>{' '}
              for:
            </p>
            <ul className="list-disc ml-6 mt-4 space-y-3 marker:text-primary">
              ...
              <li>
                Generating side-by-side comparisons of your fitness journey.
              </li>
              <li className="text-gray-400 italic">
                Note: Photos are never shared with third-party analytics (like
                Google Analytics) or used for marketing, AI training, or public
                display without your explicit, separate consent.
              </li>
            </ul>
          </section>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-black/40 rounded-lg border border-zinc-800">
                  ...
                  <p className="text-xs text-zinc-400">
                    Delete individual check-ins or photos at any time within the
                    app.
                  </p>
                </div>
              ...
              <div className="p-4 bg-red-900/10 rounded-lg border border-red-900/30 flex flex-col sm:flex-row sm:items-center justify-between gap-3 overflow-hidden">
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-zinc-400">
                    For a full account purge, contact our support team:
                  </p>
                </div>
                <a
            ...
            <div className="grid gap-4 md:grid-cols-1">
              <div className="p-4 bg-black/40 rounded-lg border border-zinc-800">
                ...
                <p className="text-sm leading-relaxed text-zinc-400">
                  ...
                  , including the Limited Use requirements. We do not sell your
                  Google user data to third parties, nor do we use it for
                  serving advertisements or performing credit worthiness checks.
                </p>
              </div>
              ...
              <div className="p-4 bg-black/40 rounded-lg border border-zinc-800">
                ...
                <p className="text-sm text-zinc-400">
                  ...
                  <strong>profile picture</strong>. This data is used
                  exclusively to create your secure account, facilitate logins,
                  and personalize your fitness dashboard. We do not request
                  access to your contacts, files, or any other sensitive scopes.
                </p>
              </div>
              ...
              <div className="p-4 bg-black/40 rounded-lg border border-zinc-800">
                ...
                <p className="text-sm text-zinc-400">
                  ...
                  active. You may revoke access at any time via your Google
                  Security Settings. To permanently delete your Amazonia -
                  FitLab account and all associated Google data from our
                  servers, please contact us at
          ...
          <section className="bg-zinc-900/50 border border-zinc-800 p-6 rounded-2xl mt-6">
            <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-2">
              <span className="text-blue-500 font-bold">5.</span> Facebook API
              Disclosure
            </h2>
            ...
            <div className="grid gap-4 md:grid-cols-1">
              <div className="p-4 bg-black/40 rounded-lg border border-zinc-800">
                ...
                <p className="text-sm text-zinc-400">
                  ...
                  FitLab profile. We do not post to your timeline or access your
                  friends list.
                </p>
              </div>
              ...
              <div className="p-4 bg-black/40 rounded-lg border border-zinc-800">
                ...
                <p className="text-sm text-zinc-400">
                  ...
                  Facebook data from our servers, please contact us at
                  <span className="text-blue-400 ml-1 break-all">
                    andyradulescu@synapselabs.org
                  </span>
                  , or do it yourself by following the instructions in our
                  <Link
              ...
              <div className="p-4 bg-black/40 rounded-lg border border-zinc-800">
                ...
                <p className="text-sm text-zinc-400">
                  ...
                  user data to outside parties. Our data handling practices
                  comply with the
                  <a
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-2">
              <span className="text-primary">6.</span> Third-Party Service
              Providers
            </h2>
            <p>
              We use trusted third-party services to operate our laboratory:
            </p>
            <ul className="list-disc ml-6 mt-4 space-y-3 marker:text-primary">
              <li>
                <strong className="text-white">Google Firebase:</strong> For
                authentication, database hosting, and secure photo storage.
              </li>
              <li>
                <strong className="text-white">Google Analytics:</strong> To
                understand app performance and improve user experience.
              </li>
              <li>
                <strong className="text-white">Meta (Facebook):</strong> To
                facilitate optional social authentication.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              18. We do not knowingly collect personal identifiable information
          ...
          <section className="border-t border-gray-800 pt-8">
            ...
            <p>
              If you have questions about this policy or encountered an error,
