      ...
      <div className="max-w-4xl mx-auto px-6 py-12 lg:py-20">
        <header className="mb-16 text-center">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto">
            Instructions on how to manage, export, and permanently remove your
            fitness data and photos from our servers.
          </p>
        </header>
          ...
          <main className="space-y-10">
            <section>
              ...
              <ol className="space-y-6">
                <li className="flex gap-4">
                  <span className="flex-shrink-0 w-8 h-8 rounded-full bg-zinc-800 text-white flex items-center justify-center font-bold">
                    1
                  </span>
                  <p>
                    Open the{' '}
                    <strong className="text-white">Amazonia - FitLab</strong>{' '}
                ...
                <li className="flex gap-4">
                  ...
                  <p>
                    Navigate to your{' '}
                    <strong className="text-white">Profile Settings</strong> by
                    tapping the user icon.
                  </p>
                </li>
                <li className="flex gap-4">
                  <span className="flex-shrink-0 w-8 h-8 rounded-full bg-zinc-800 text-white flex items-center justify-center font-bold">
                ...
                <li className="flex gap-4">
                  <span className="flex-shrink-0 w-8 h-8 rounded-full bg-red-900/30 text-red-500 flex items-center justify-center font-bold">
                    4
                  </span>
                  <p>
                    Select{' '}
            ...
            <section className="bg-zinc-900/30 p-6 rounded-2xl border border-zinc-800">
              ...
              <p className="text-sm leading-relaxed">
                Our automated cleanup strategy will immediately trigger. This
                process wipes your
                <strong> Authentication Record</strong>, all{' '}
                <strong>Firestore Documents</strong> (check-ins, body metrics,
                and start data), and permanently removes all{' '}
                <strong>Cloud Storage Photos</strong>.
              </p>
            </section>
          </main>
          ...
          <aside className="space-y-6">
            <div className="relative aspect-[9/16] w-full max-w-[300px] mx-auto rounded-3xl border-[8px] border-zinc-800 overflow-hidden bg-zinc-900 shadow-2xl">
              <div className="absolute inset-0 flex items-center justify-center text-zinc-700 text-center p-8 italic">
                <Image
                  src="/data-deletion.jpg"
                  alt="Delete account screenshot"
                  fill
            ...
            <table className="w-full text-left text-sm border-collapse">
              <thead>
                <tr className="border-b border-zinc-800">
                  <th className="py-4 font-semibold text-primary">
                    Data Category
                  </th>
                  <th className="py-4 font-semibold text-primary">
                    Storage Type
        ...
        <footer className="mt-20 pt-8 border-t border-zinc-900 text-center">
          <p className="text-gray-600 mb-4">
            Cannot access your account? We can help.
          </p>
          <a
            href="mailto:andyradulescu@synapselabs.org"
            className="primary-gradient text-black px-8 py-3 rounded-full font-bold"
          >
