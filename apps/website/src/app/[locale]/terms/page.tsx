      ...
      <div className="prose prose-slate max-w-none space-y-8">
        <section>
          <p className="leading-relaxed">
            Welcome to <strong>Amazonia - FitLab</strong>. By accessing or using
        ...
        <section className="bg-slate-700 border-l-4 border-red-400 p-6 rounded-r-md">
          ...
          <p className="mb-0">
            Amazonia - FitLab provides fitness and wellness information for
            educational purposes only. This is{' '}
            <strong>not medical advice</strong>. Always consult your physician
            before starting any new exercise program. You voluntarily assume all
        ...
        <section>
          ...
          <p>
            ...
            our platform, you represent that you have the legal capacity to
        ...
        <section>
          ...
          <p>
            Amazonia - FitLab shall not be liable for any injuries or damages
            resulting from your use of the service. Our liability is limited to
            the maximum extent permitted by law in your jurisdiction.
          </p>
        </section>
