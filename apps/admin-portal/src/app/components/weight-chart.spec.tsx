...
describe('WeightChart', () => {
  ...
  const mockWeights = [
    {
      id: 'w1',
      weight: 80.5,
      createdAt: '2024-01-08T10:00:00Z', // 9 days ago (filtered out by 1w),
      updatedAt: undefined
    },
    {
      id: 'w2',
      weight: 79.8,
      createdAt: '2024-01-08T10:00:00Z', // 2 days ago (included in 1w)
      updatedAt: undefined
    }
  ] satisfies WeightString[];

  it('should render "No data" message when weights array is empty', () => {
    render(<WeightChart weights={[]} timeRange="4w" />);
  ...
  it('should render the chart container when data is provided within the default 1w range', () => {
    const { container } = render(<WeightChart weights={mockWeights} timeRange="4w" />);
  ...
  it('should correctly format dates in the data memo', () => {
    ...
    render(<WeightChart weights={mockWeights} timeRange="4w" />);
