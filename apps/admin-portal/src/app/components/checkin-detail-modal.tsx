...
export const CheckinDetailModal = ({ checkin, isOpen, onClose }: CheckinDetailModalProps) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} className="!max-w-4xl">
      <div className="bg-white rounded-2xl w-full h-full overflow-hidden flex flex-col shadow-2xl">
