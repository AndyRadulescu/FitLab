...
export const CheckinList = ({ checkins, weights, onSelectCheckin }: CheckinListProps) => {
        ...
        {checkins.map((checkin) => (
          ...
          >
            ...
            <div className="text-indigo-600 font-medium text-sm flex items-center gap-1 group">
              View Details
              <svg className="h-4 w-4 transform transition-transform group-hover:translate-x-1" fill="none"
